...
export class WhirlpoolStrategy {
  ...
  static readonly discriminator = Buffer.from([190, 178, 231, 184, 49, 186, 103, 13]);
  ...
  constructor(fields: WhirlpoolStrategyFields) {
    ...
    this.raydiumProtocolPositionOrBaseVaultAuthority = fields.raydiumProtocolPositionOrBaseVaultAuthority;
    this.blockDeposit = fields.blockDeposit;
    this.raydiumPoolConfigOrBaseVaultAuthority = fields.raydiumPoolConfigOrBaseVaultAuthority;
  ...
  static async fetch(c: Connection, address: PublicKey): Promise<WhirlpoolStrategy | null> {
  ...
  static async fetchMultiple(c: Connection, addresses: PublicKey[]): Promise<Array<WhirlpoolStrategy | null>> {
  ...
  static decode(data: Buffer): WhirlpoolStrategy {
    ...
    return new WhirlpoolStrategy({
      ...
      kaminoRewards: dec.kaminoRewards.map((item: any /* eslint-disable-line @typescript-eslint/no-explicit-any */) =>
  ...
  toJSON(): WhirlpoolStrategyJSON {
    return {
      ...
      raydiumProtocolPositionOrBaseVaultAuthority: this.raydiumProtocolPositionOrBaseVaultAuthority.toString(),
      blockDeposit: this.blockDeposit.toString(),
      raydiumPoolConfigOrBaseVaultAuthority: this.raydiumPoolConfigOrBaseVaultAuthority.toString(),
  ...
  static fromJSON(obj: WhirlpoolStrategyJSON): WhirlpoolStrategy {
    return new WhirlpoolStrategy({
      ...
      raydiumProtocolPositionOrBaseVaultAuthority: new PublicKey(obj.raydiumProtocolPositionOrBaseVaultAuthority),
      blockDeposit: new BN(obj.blockDeposit),
      raydiumPoolConfigOrBaseVaultAuthority: new PublicKey(obj.raydiumPoolConfigOrBaseVaultAuthority),
