...
export class TickUtil {
   ...
   */
  public static getTick(tickArray: TickArrayData, tickIndex: number, tickSpacing: number): TickData {
  ...
  private static findInitializedTick(
    ...
    let stepInitializedTickArrayIndex =
      searchDirection === TickSearchDirection.Right ? currentTickArrayIndex + increment : currentTickArrayIndex;
  ...
  public static getNextInitializableTickIndex(tickIndex: number, tickSpacing: number, aToB: boolean): number {
    if (!aToB) {
