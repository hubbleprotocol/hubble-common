...
export class TickArrayState {
  ...
  static readonly discriminator = Buffer.from([192, 155, 85, 205, 49, 249, 129, 42]);
  ...
  static async fetch(c: Connection, address: PublicKey): Promise<TickArrayState | null> {
  ...
  static async fetchMultiple(c: Connection, addresses: PublicKey[]): Promise<Array<TickArrayState | null>> {
