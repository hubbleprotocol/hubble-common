...
export const layout = borsh.struct([borsh.u64('kaminoRewardIndex'), borsh.u64('amount')]);

export function addKaminoRewards(args: AddKaminoRewardsArgs, accounts: AddKaminoRewardsAccounts) {
