...
export const layout = borsh.struct([borsh.u8('rewardIndex'), borsh.u8('collateralToken')]);

export function updateRewardMapping(args: UpdateRewardMappingArgs, accounts: UpdateRewardMappingAccounts) {
