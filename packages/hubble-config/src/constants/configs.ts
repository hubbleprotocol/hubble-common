...
export const HUBBLE_CONFIGS: HubbleConfig[] = [
  {
    ...
    borrowing: {
      ...
      accounts: {
        ...
        borrowingMarketState: new PublicKey('4KMctTNChfrd3yjj6JFmbL8tkE6EamADHDDzo2wZfCCu'),
  ...
  },
  {
    ...
    borrowing: {
      ...
      accounts: {
        ...
        collateralVaultsAuthority: new PublicKey(new PublicKey('5t8jZ1T6cR79vEu5Vo1Jc6Q3RaYtLsNJdPTLLu4z9vX3')),
        collateralVault: {
        ...
        borrowingMarketState: new PublicKey('7bXMDpS8WDSrfKK1Xai4LsGRAiwpzD3YzD3tUNyovmNh'),
