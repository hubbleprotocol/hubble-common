...
export const HUBBLE_CONFIGS: HubbleConfig[] = [
  {
    ...
    kaminoLending: [
      {
        lendingMarket: new PublicKey('BwrNjHN3UxnNnWBX4zUnoHtkypHHyvXdCW6mv7YxKEvY'),
        lendingMarketAuthority: new PublicKey('5pWdNLeYUwab5ar5Pr9MfmBKNkhveJGwn6M9dQt6Uay3'),
        isPrimary: true,
        reserves: [
          {
            liquidityToken: {
            ...
            address: new PublicKey('73UFaxKuFPxKgPaGiG4rbxX1by3S4ZFUCcn3Xz2KHEi5'),
            collateralMint: new PublicKey('DvMcaH12ERtDowFHhP5STVTSJEs4E9grKZDcn3KE64be'),
            collateralSupply: new PublicKey('4J3YyCtV38FCNwWgmTnNG7M7LQ5r6ufVDUU5UeDwYqyq'),
            liquiditySupply: new PublicKey('8bJqaHUobfduKQLu6Vxmw9y9BDCd4w4e3qnnKV4yyNuC'),
            liquidityFeeReceiverAddress: new PublicKey('8fzaeYqL5hSKyuAS1tXenSJRVUYZvRafuKUsCeaNv6ay'),
          ...
          },
          {
            ...
            address: new PublicKey('7Ue6AGahRCkpFGJ8sviSf89h4Fka7u3uZBCL6DMXThzX'),
            collateralMint: new PublicKey('CjRHfXFhoLiKUfVHKskuv8S1N5y13FxEmEATLsLsJvoP'),
            collateralSupply: new PublicKey('CUy9pfhsiqahYPbmyhG6HFNDVdtsXRiidWxnzqKt3nu'),
            liquiditySupply: new PublicKey('29pzBBCVJHPtWL44gNaYP2kZx1igaK5czNjMhm3tFRA2'),
            liquidityFeeReceiverAddress: new PublicKey('8ceoC4XvccKNtFhURTrFbsx8BjQoM2jym87WwWMRVcBp'),
            pythOracle: new PublicKey('nu11111111111111111111111111111111111111111'),
            switchboardOracle: new PublicKey('4wv7S1M1pxex1xaAy6HUDnsQ37TF152nmqiuktssJWt9'),
          },
          {
            liquidityToken: {
              decimals: 6,
            ...
            address: new PublicKey('Hqeat4acfTdXUaAtPtHeYvvuMaGq33j6ymtNsdRyNXjQ'),
            collateralMint: new PublicKey('2mwrJhYHg4TTCFjvTQQPyp1gdwYoBfGGsNS6CpnbdtYE'),
            collateralSupply: new PublicKey('6ZLA5jhTEm4JPc3UPAWoTz329pH8ZREmAvSnrtEezENs'),
            liquiditySupply: new PublicKey('Fr7KvNCda1LG9fFucDkGNwJEjSMzfZTP6FLaEjVi4KED'),
            liquidityFeeReceiverAddress: new PublicKey('GuYx8RA7JJgSkQexXPaHQtRHfjWRQzVWECVCHTcqjXa4'),
          ...
          },
          {
            ...
            address: new PublicKey('2ouEbmbjmTf8zaRsgkAwgGAgahnAbopcvV8tdyeFdyEC'),
            collateralMint: new PublicKey('26fucH9bQokt58fsXX8JV9foma5nz771BEHLvYuc6XDM'),
            collateralSupply: new PublicKey('758XgPppoWN6fVBg95cRmmJTmrcugzNpYwfZrXKBuziD'),
            liquiditySupply: new PublicKey('6Tou2f6gbyusL77MRuiKSSfYoEC4p26F4aZ4jJaMbLqt'),
            liquidityFeeReceiverAddress: new PublicKey('2iGM5T8fcL4BK4vBGPXr2uhx3FbUEmtBpBV7Qk1zuy3A'),
            pythOracle: new PublicKey('Bt1hEbY62aMriY1SyQqbeZbm8VmSbQVGBFzSzMuVNWzN'),
          ...
          },
          {
            liquidityToken: {
              ...
              mint: new PublicKey('5BmZgW7dk1kximGfn7MPvDigp3yRmgT64jS9Skdq4nPY'),
            },
            address: new PublicKey('J4RQpBk4T7AraDKdgkiYjCDajRJ2c3T3AczRV1n1xFiV'),
            collateralMint: new PublicKey('HJwSU8qVbj6ZBa3VniGxh2Gfk6meYELoVWtPeaNY2hAn'),
            collateralSupply: new PublicKey('J3ixG8GZSFghYU8aRVY55mZZ1ZZR1CHbrSGFm7HEjc5U'),
            liquiditySupply: new PublicKey('9GBoJxpXkLqWgLUmvoiu2XTjb9WbYcBb2GUU8Ef36zv'),
            liquidityFeeReceiverAddress: new PublicKey('6VT1TMsfn2fje6vdrAsJbjXi5xbNTapp7yvGfwFXPTbY'),
            pythOracle: new PublicKey('nu11111111111111111111111111111111111111111'),
            switchboardOracle: new PublicKey('GeKKsopLtKy6dUWfJTHJSSjFTuMagFmKyuq2FHUWDkhU'),
          },
          {
            liquidityToken: {
              decimals: 9,
              symbol: 'kSOLSTSOLOrca',
              mint: new PublicKey('C7RpHABBJjfkmizgnR2MRbpfEF454Rb18XC6RmBC8cGg'),
            },
            address: new PublicKey('82TaFLYe3kjt5ZUjsvgEYzRS7tYwWHMdkrZx2NUifdxe'),
            collateralMint: new PublicKey('2byQVvbmFbRX3Vtv19Y3fu81rBU8NmFwpCCTrMQm33PD'),
            collateralSupply: new PublicKey('Az92ZVMMjkrKe1f2udizYibJfxsBK6dj4LmThkQWvzgc'),
            liquiditySupply: new PublicKey('3uWvKerbEyNh8aprCshWs5wNRtG2RpWEh5hBZpGU2Q5j'),
            liquidityFeeReceiverAddress: new PublicKey('6SkD79YKR4KmdwTHiaLz5kr4kjRXSrQCYJeD7teBDbZy'),
            pythOracle: new PublicKey('nu11111111111111111111111111111111111111111'),
            switchboardOracle: new PublicKey('2bpwkRWDEXHWYNBDddKssz6te82zCqwLR8qhR2acUtep'),
          },
        ],
      },
    ],
