...
export const HUBBLE_CONFIGS: HubbleConfig[] = [
  {
    ...
    kamino: {
      ...
      strategies: [
        ...
        new PublicKey('Ff7vqYLUKuWatkffALjzhHzLLwLreACoxAg7eFdYcbfr'),
        new PublicKey('nnSKzSq2FmMP2gtCKrTT162rDAXPfZNmHfgMhkabY2y'),
        new PublicKey('7q3pH3xy2kA8ihCojDSBKnufdDiUHBnkArdsQrfpAkoY'),
        new PublicKey('HcHkvZEDechu7bruV8zvMN11v9yHg3iY4QHNgrYUATmg'),
        new PublicKey('DUzyXdsAQWkoFKCmrxk7oYz6S59XXEjcRfqvXBQiyFUM'),
        new PublicKey('7uLHeFCxGWzXZNLH5S6xUQrV5im1sVAV3YYmusf9avsC'),
      ],
