...
export const HUBBLE_CONFIGS: HubbleConfig[] = [
  {
    ...
    kaminoLending: {
      programId: new PublicKey('7LVRdi61Smyr6rW1DtWZSkipr6jBvHPxPG1cQ74tZLWZ'),
      lendingMarket: new PublicKey('6StR6RJu2WTtNMPcb9373uiy2gJ24mPmxQPGrY2qN44Q'),
      lendingMarketAuthority: new PublicKey('ArETTZG933XWtqHMXuMDc4NEPMQS1JnBqWeCymhqGjc'),
      reserves: [
        {
        ...
        {
          liquidityMint: new PublicKey('USDH1SM1ojwWUga67PGrgFWUHibbjqMvuMaDkRJTgkX'),
        ...
        {
          liquidityMint: new PublicKey('7dHbWXmci3dT8UFYWYZweBLXgycu7Y3iL6trKn1Y7ARj'),
        ...
        {
          liquidityMint: new PublicKey('5BmZgW7dk1kximGfn7MPvDigp3yRmgT64jS9Skdq4nPY'),
        ...
        {
          liquidityMint: new PublicKey('C7RpHABBJjfkmizgnR2MRbpfEF454Rb18XC6RmBC8cGg'),
  ...
  },
  {
    ...
    kaminoLending: {
      programId: new PublicKey('5HoQMHZHiqAYtYp7U5kFzK1Vv54CaiK8ya474wU2Ujdf'),
      ...
      reserves: [
        ...
        {
          liquidityMint: new PublicKey('HWzkNyXynnC3mAZAL4yKZNvWs3SwS9eBVKdzmKcxYHSH'),
        ...
        {
          liquidityMint: new PublicKey('8KinRubdHLTivgyS6kv5Rph7kkMv5sdCroTSXNeq1sWq'),
        ...
        {
          liquidityMint: new PublicKey('G89c7G8YkQQGP3hyPHM2Jn3x2xn5zKZRPspCwVMfzsMT'),
        ...
        {
          liquidityMint: new PublicKey('E8KG1XTQE3bf6ZTDG7xa38PAbAxHaDumsAgmGraY58MQ'),
