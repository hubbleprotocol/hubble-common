...
export const HUBBLE_CONFIGS: HubbleConfig[] = [
  ...
  },
  {
    ...
    kaminoLending: [
      {
        lendingMarket: new PublicKey('EFWpAcP7ua1ZT3E22KDc6CwQtfQNUMHkGZNbEFP9zdD5'),
        lendingMarketAuthority: new PublicKey('Dw2qQzV1nCu12iZanJUXqPTszrdVMbbq3zyydUjYaLqR'),
        isPrimary: true,
        reserves: [
          {
            liquidityToken: {
            ...
            address: new PublicKey('ExD17AK8Ds9btvmEky9hQKdzMnbTHxe5YDaVVtzWdcog'),
            collateralMint: new PublicKey('DGs9jV5Y6nt9E9XfRvg9Un1Za9jxVYdJDK4mpRfQXb9M'),
            collateralSupply: new PublicKey('9VK3DkGKjUWJSzFFG1Tr3XbdkZ5ayHqats4YXku1tBsJ'),
            liquiditySupply: new PublicKey('AJHjvHXf7JoN4rv7DNh4cdbnjhMuJyNGk9XS5QRVCWMK'),
            liquidityFeeReceiverAddress: new PublicKey('AMmfHWhMbXV67eEsQcLZV7S8M1qTaGLuBEmJMxHJzDGp'),
          ...
          },
          {
            ...
            address: new PublicKey('ASCeCq6tSyMzbjVuw5qdxvF9Czc2pBTvBp93VvV2e24P'),
            collateralMint: new PublicKey('7JG163VLMDzadQEd2LQX745gw48vuT34wqo2ttdj5ZmS'),
            collateralSupply: new PublicKey('Rm77DwAN7xqjyXcmgNxeNbBTuHqqpFs7t4HfcYAKGkU'),
            liquiditySupply: new PublicKey('AXsKEAxmvTs55LZkr7DMJNnJCiqP1t6CHfJwheMp63z7'),
            liquidityFeeReceiverAddress: new PublicKey('EuqWwHXGMVYmtKPq1fCBw4Z11Vo5AnoysQ9P669Rktq7'),
            pythOracle: new PublicKey('nu11111111111111111111111111111111111111111'),
