...
export const HUBBLE_CONFIGS: HubbleConfig[] = [
  {
    ...
    kamino: {
      liveStrategies: [
        ...
        {
          address: new PublicKey('A9PREFQDWkUhvfxVLPd4tuZjF8baZL5PkhiUE55MyQN8'),
          type: 'NON_PEGGED',
          shareMint: new PublicKey('7pRaM2gZzsBBStiPKHMWC16WAohvdohAzoJ9FeYNQz7N'),
          status: 'LIVE',
        },
        {
          address: new PublicKey('7iadogUMU94zcH3QBo43dDhGDXmwy1NVZHtjjUzWnTng'),
          type: 'PEGGED',
          shareMint: new PublicKey('EUrAyrpvyPRJFxGtk6G8uZJxqaZYxjwHFXUDqxGqN7qB'),
          status: 'LIVE',
        },
        {
          address: new PublicKey('AL6Yd51aSY3S9wpuypJYKtEf65xBSXKpfUCxN54CaWeE'),
          type: 'PEGGED',
          shareMint: new PublicKey('wdCdhedvexEdECNsfhGiwZQA5tEoqLZxecBCwvN3w27'),
          status: 'LIVE',
        },
      ],
      mints: [
      ...
      strategies: [
        ...
        new PublicKey('AL6Yd51aSY3S9wpuypJYKtEf65xBSXKpfUCxN54CaWeE'),
        new PublicKey('7iadogUMU94zcH3QBo43dDhGDXmwy1NVZHtjjUzWnTng'),
        new PublicKey('A9PREFQDWkUhvfxVLPd4tuZjF8baZL5PkhiUE55MyQN8'),
      ],
